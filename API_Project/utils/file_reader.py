...
if __name__ == '__main__':
    ...
    y = os.path.join(os.path.split(os.path.dirname(os.path.abspath(__file__)))[0], 'config', 'config.yml')
    reader = YamlReader(y)
    print(reader.data)

    e = os.path.join(os.path.split(os.path.dirname(os.path.abspath(__file__)))[0], 'data', 'baidu.xlsx')
